      ...
      <Stack justifyContent={"center"} alignItems={"center"}>
        ...
        <Box sx={{ maxWidth: 800, margin: 2, backgroundColor: "bisque", padding: 7, borderRadius: 15 }}>
          <List sx={{ listStyleType: "disc" }}>
            ...
            <ListItem sx={{ display: "list-item" }}>
              Second paramter on the useEffect controls when the hook runs i.e. only when the state changes this will
              run.
            </ListItem>
            <ListItem sx={{ display: "list-item" }}>
            ...
            <ListItem sx={{ display: "list-item" }}>
              <span style={{ fontWeight: "bold" }}>ComponentUnMount: </span> Put a return function in the useEffect and
              this carryout 'CleanUp'.
            </ListItem>
          </List>
        </Box>
